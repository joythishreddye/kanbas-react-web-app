            ...
            <Faculty>
                ...
                <div className="dropdown d-inline me-1 float-end">
                    ...
                    <ul className="dropdown-menu">
                        <li>
                            <button id="wd-publish-all-modules-and-items-btn"
                        ...
                        <li>
                            <button id="wd-publish-modules-only-button"
                                    className="dropdown-item btn btn-link"
                            >
                                <GreenCheckmark/>
                        ...
                        <li>
                            <button id="wd-unpublish-all-modules-and-items"
                                    className="dropdown-item btn btn-link"
                            >
                                <GreenCheckmark/>
                        ...
                        <li>
                            <button id="wd-unpublish-modules-only"
                                    className="dropdown-item btn btn-link"
                            >
                                <GreenCheckmark/>
